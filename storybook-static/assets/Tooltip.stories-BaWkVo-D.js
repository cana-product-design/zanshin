import{j as e}from"./jsx-runtime-DiklIkkE.js";import{R as i}from"./index-DRjF_FHU.js";import{B as l}from"./Button-2KxsfuRR.js";function a({content:m,placement:f="top",delay:w=150,children:p}){const[s,g]=i.useState(!1),[A,x]=i.useState(!1),u=i.useRef(),h=`zanshin-tooltip-${i.useId().replace(/:/g,"")}`,b=()=>{u.current=setTimeout(()=>{x(!0),requestAnimationFrame(()=>g(!0))},w)},v=()=>{clearTimeout(u.current),g(!1),setTimeout(()=>x(!1),200)};i.useEffect(()=>()=>clearTimeout(u.current),[]);const t=6,z={top:{bottom:"100%",left:"50%",transform:`translateX(-50%) translateY(${s?"-6px":"0px"})`,marginBottom:`${t}px`},bottom:{top:"100%",left:"50%",transform:`translateX(-50%) translateY(${s?"6px":"0px"})`,marginTop:`${t}px`},left:{right:"100%",top:"50%",transform:`translateY(-50%) translateX(${s?"-6px":"0px"})`,marginRight:`${t}px`},right:{left:"100%",top:"50%",transform:`translateY(-50%) translateX(${s?"6px":"0px"})`,marginLeft:`${t}px`}},E={top:{bottom:-t,left:"50%",transform:"translateX(-50%)",borderLeft:`${t}px solid transparent`,borderRight:`${t}px solid transparent`,borderTop:`${t}px solid #1A2744`},bottom:{top:-t,left:"50%",transform:"translateX(-50%)",borderLeft:`${t}px solid transparent`,borderRight:`${t}px solid transparent`,borderBottom:`${t}px solid #1A2744`},left:{right:-t,top:"50%",transform:"translateY(-50%)",borderTop:`${t}px solid transparent`,borderBottom:`${t}px solid transparent`,borderLeft:`${t}px solid #1A2744`},right:{left:-t,top:"50%",transform:"translateY(-50%)",borderTop:`${t}px solid transparent`,borderBottom:`${t}px solid transparent`,borderRight:`${t}px solid #1A2744`}},L={position:"absolute",zIndex:9999,background:"#1A2744",color:"#F5F4EF",padding:"var(--space-2) var(--space-3)",borderRadius:"var(--radius-md)",fontFamily:"var(--font-body)",fontSize:"0.8125rem",lineHeight:1.4,whiteSpace:"nowrap",pointerEvents:"none",opacity:s?1:0,transition:"opacity 200ms var(--ease-kendo), transform 200ms var(--ease-kendo)",maxWidth:"280px",...z[f]},S=i.cloneElement(p,{"aria-describedby":s?h:void 0,onMouseEnter:n=>{var o,r;b(),(r=(o=p.props).onMouseEnter)==null||r.call(o,n)},onMouseLeave:n=>{var o,r;v(),(r=(o=p.props).onMouseLeave)==null||r.call(o,n)},onFocus:n=>{var o,r;b(),(r=(o=p.props).onFocus)==null||r.call(o,n)},onBlur:n=>{var o,r;v(),(r=(o=p.props).onBlur)==null||r.call(o,n)}});return e.jsxs("span",{style:{position:"relative",display:"inline-flex"},children:[S,A&&e.jsxs("span",{id:h,role:"tooltip",style:L,children:[m,e.jsx("span",{"aria-hidden":"true",style:{position:"absolute",width:0,height:0,...E[f]}})]}),e.jsx("style",{children:`
